...
\lstdefinelanguage{mylatex}{
  ...
  moretexcs   =
    {
      usepackage, documentclass, LaTeX, LaTex, label, ref, tableofcontents, begin, end, bibliography, bibliographystyle, cite, NeedsTeXFormat, ProvidesPackage, newcommand, mycmd, printbibliography, addbibresource
    }
}
